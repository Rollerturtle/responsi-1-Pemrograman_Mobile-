...
class _FormIkanScreenState extends State<FormIkanScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text(widget.ikan == null ? 'Introduce Fish' : 'Re-introduce Fish'),
      ),
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(labelText: 'Fish Type'),
            ),
            TextFormField(
              controller: _warnaController,
              decoration: InputDecoration(labelText: 'Fish Colors'),
            ),
            TextFormField(
              controller: _habitatController,
              decoration: InputDecoration(labelText: 'Fish Habitats'),
            ),
            Center(
              child: TextButton(
                onPressed: () {
